...
String BOTtoken = "5568202885:AAEIuA1W3Pm_c9_Ju4KZxW9piCB-O3XzMTQ"; // your
Bot Token (Get from Botfather)
// Use @myidbot to find out the chat ID of an individual or a group
// Also note that you need to click "start" on a bot before it can
// message you
String CHAT_ID = "1116761518";
...
sensor_t * s = esp_camera_sensor_get();#include <Arduino.h>
#include <WiFi.h>
#include <WiFiClientSecure.h>
#include "soc/soc.h"
#include "soc/rtc_cntl_reg.h"
...
welcome += "Smart School Bus - PHOTO ALERT \n";
