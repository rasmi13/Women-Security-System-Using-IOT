...
lcd.clear();
lcd.setCursor(0,0);lcd.print("Women Security ");
lcd.setCursor(0,1);lcd.print("System Using IOT");delay(5000);lcd.clear();
...
{
float latitude=17.520588;
float logitude=78.630969;
lcd.clear();
lcd.print("Lat:17.520588");
lcd.setCursor(0,1);
lcd.print("Log:78.630969");
delay(2000);
lcd.clear();
}
...
");delay(2000);Send();delay(2000);
digitalWrite(CAM,LOW);delay(100);delay(100);
initModule("AT","OK",1000);initModule("AT","OK",1000);
lcd.clear();lcd.print("CALLING------1 ");
Serial1.print("ATD+91");Serial1.print("9390971342");
Serial1.print(";\r\n");delay(12000);
Serial1.println("ATH");delay(2000);
initModule("AT","OK",1000);initModule("AT","OK",1000);lcd.clear();
lcd.clear();lcd.print("CALLING------2 ");
Serial1.print("ATD+91");Serial1.print("9391064641");
Serial1.print(";\r\n");delay(12000);
Serial1.println("ATH");delay(2000);
initModule("AT","OK",1000);initModule("AT","OK",1000);lcd.clear();
lcd.clear();lcd.print("CALLING------3 ");
Serial1.print("ATD+91");Serial1.print("6309409135");
Serial1.print(";\r\n");delay(12000);
Serial1.println("ATH");delay(2000);
initModule("AT","OK",1000);initModule("AT","OK",1000);lcd.clear();
goto st;
...
void init_sms1()
{Serial1.println("AT+CMGF=1");delay(400);Serial1.println("AT+CMGS=\"93909713
42\""); delay(400);}
void init_sms2()
{Serial1.println("AT+CMGF=1");delay(400);Serial1.println("AT+CMGS=\"93910646
41\""); delay(400);}
void init_sms3()
{Serial1.println("AT+CMGF=1");delay(400);Serial1.println("AT+CMGS=\"63094091
35\""); delay(400);}
...
Serial1.print(latitude,6);Serial1.print(",");Serial1.print(logitude,6);Seria
l1.write(26);delay(2000);
}
else
{
Serial1.print("https://www.google.com/maps/place/17.520588,78.630969");
delay(500);Serial1.write(26);delay(2000);
}
delay(2000);lcd.clear();lcd.print("Message Sent "); delay(1000);
lcd.clear();
Serial1.print("AT\r\n");delay(500);Serial1.print("AT\r\n");delay(500);Serial
1.println("AT+CMGF=1");delay(200);lcd.clear();
lcd_status();
}
void Send()
{
...
init_sms3();delay(1000);lcd.clear();lcd.print("Sending SMS3 ");Send_sms();
}
